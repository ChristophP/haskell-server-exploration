...
/* package haskell-snap-0.1 */
#define VERSION_haskell_snap "0.1"
#define MIN_VERSION_haskell_snap(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "haskell-snap-0.1"

#define CURRENT_PACKAGE_KEY "haskell-snap-0.1"
